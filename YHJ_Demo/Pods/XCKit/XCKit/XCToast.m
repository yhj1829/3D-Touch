...
+ (XCToast *)createWithText:(NSString *)text {
	...
	if (SYSTEM_VERSION_GREATER_THAN_OR_EQUAL_TO(@"7.0")) {
        ...
        size = [textLabel.text boundingRectWithSize:CGSizeMake(textLabel.frame.size.width, CGFLOAT_MAX)
	...
	XCToast *toast = [[XCToast alloc] initWithFrame:CGRectMake(0, 0, size.width + 30, size.height + 30)];
...
+ (void)showWithText:(NSString *)text {
	XCToast *toast = [XCToast createWithText:text];
